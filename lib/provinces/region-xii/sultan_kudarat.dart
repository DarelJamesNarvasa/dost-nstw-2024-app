...
class SultanKudaratPage extends StatefulWidget {
  @override
  _SultanKudaratPageState createState() => _SultanKudaratPageState();
}

class _SultanKudaratPageState extends State<SultanKudaratPage> {
