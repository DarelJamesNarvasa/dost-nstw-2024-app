...
class NuevaVizcayaPage extends StatefulWidget {
  @override
  _NuevaVizcayaPageState createState() => _NuevaVizcayaPageState();
}

class _NuevaVizcayaPageState extends State<NuevaVizcayaPage> {
