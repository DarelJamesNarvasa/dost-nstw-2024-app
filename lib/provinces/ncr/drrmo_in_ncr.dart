...
class DrrmoInNcrPage extends StatefulWidget {
  @override
  _DrrmoInNcrPageState createState() => _DrrmoInNcrPageState();
}

class _DrrmoInNcrPageState extends State<DrrmoInNcrPage> {
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: Center(
            child: const Text(
              'Disaster Risk Reduction and Management Offices in National Capital Region',
              style: TextStyle(
                fontFamily: 'Roboto',
                color: Colors.black,
              ),
