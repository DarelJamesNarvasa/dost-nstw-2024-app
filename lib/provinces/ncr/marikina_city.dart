...
class MarikinaCityPage extends StatefulWidget {
  @override
  _MarikinaCityPageState createState() => _MarikinaCityPageState();
}

class _MarikinaCityPageState extends State<MarikinaCityPage> {
