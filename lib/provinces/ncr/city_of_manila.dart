...
class CityOfManilaPage extends StatefulWidget {
  @override
  _CityOfManilaPageState createState() => _CityOfManilaPageState();
}

class _CityOfManilaPageState extends State<CityOfManilaPage> {
