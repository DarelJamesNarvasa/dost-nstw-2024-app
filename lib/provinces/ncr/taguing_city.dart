...
class TaguingCityPage extends StatefulWidget {
  @override
  _TaguingCityPageState createState() => _TaguingCityPageState();
}

class _TaguingCityPageState extends State<TaguingCityPage> {
