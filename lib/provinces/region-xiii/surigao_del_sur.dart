...
class SurigaoDelSurPage extends StatefulWidget {
  @override
  _SurigaoDelSurPageState createState() => _SurigaoDelSurPageState();
}

class _SurigaoDelSurPageState extends State<SurigaoDelSurPage> {
