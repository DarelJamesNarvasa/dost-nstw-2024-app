...
class DinagatIslandsPage extends StatefulWidget {
  @override
  _DinagatIslandsPageState createState() => _DinagatIslandsPageState();
}

class _DinagatIslandsPageState extends State<DinagatIslandsPage> {
