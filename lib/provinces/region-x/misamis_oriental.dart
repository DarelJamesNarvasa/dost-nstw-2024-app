...
class MisamisOrientalPage extends StatefulWidget {
  @override
  _MisamisOrientalPageState createState() => _MisamisOrientalPageState();
}

class _MisamisOrientalPageState extends State<MisamisOrientalPage> {
  final List<Map<String, String>> projectVideos = [
    {
      'project': 'Project 1',
      'video': 'assets/videos/1_minute_DOST-X.mp4', 'thumbnail': 'assets/images/project1_thumbnail.png'
    },
  ];
