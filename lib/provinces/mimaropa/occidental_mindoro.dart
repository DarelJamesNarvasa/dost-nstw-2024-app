...
class OccidentalMindoroPage extends StatefulWidget {
  @override
  _OccidentalMindoroPageState createState() => _OccidentalMindoroPageState();
}

class _OccidentalMindoroPageState extends State<OccidentalMindoroPage> {
