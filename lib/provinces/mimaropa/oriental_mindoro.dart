...
class OrientalMindoroPage extends StatefulWidget {
  @override
  _OrientalMindoroPageState createState() => _OrientalMindoroPageState();
}

class _OrientalMindoroPageState extends State<OrientalMindoroPage> {
