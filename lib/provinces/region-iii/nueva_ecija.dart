...
class NuevaEcijaPage extends StatefulWidget {
  @override
  _NuevaEcijaPageState createState() => _NuevaEcijaPageState();
}

class _NuevaEcijaPageState extends State<NuevaEcijaPage> {
