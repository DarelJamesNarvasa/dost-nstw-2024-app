...
class NorthernSamarPage extends StatefulWidget {
  @override
  _NorthernSamarPageState createState() => _NorthernSamarPageState();
}

class _NorthernSamarPageState extends State<NorthernSamarPage> {
