...
class EasternSamarPage extends StatefulWidget {
  @override
  _EasternSamarPageState createState() => _EasternSamarPageState();
}

class _EasternSamarPageState extends State<EasternSamarPage> {
