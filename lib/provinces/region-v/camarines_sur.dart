...
class CamarinesSurPage extends StatefulWidget {
  @override
  _CamarinesSurPageState createState() => _CamarinesSurPageState();
}

class _CamarinesSurPageState extends State<CamarinesSurPage> {
