...
class MaguindanaoPage extends StatefulWidget {
  @override
  _MaguindanaoPageState createState() => _MaguindanaoPageState();
}

class _MaguindanaoPageState extends State<MaguindanaoPage> {
