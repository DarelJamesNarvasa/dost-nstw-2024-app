...
class DavaoOccidentalPage extends StatefulWidget {
  @override
  _DavaoOccidentalPageState createState() => _DavaoOccidentalPageState();
}

class _DavaoOccidentalPageState extends State<DavaoOccidentalPage> {
