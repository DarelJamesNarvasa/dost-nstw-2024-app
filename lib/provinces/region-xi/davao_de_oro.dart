...
class DavaoDeOroPage extends StatefulWidget {
  @override
  _DavaoDeOroPageState createState() => _DavaoDeOroPageState();
}

class _DavaoDeOroPageState extends State<DavaoDeOroPage> {
