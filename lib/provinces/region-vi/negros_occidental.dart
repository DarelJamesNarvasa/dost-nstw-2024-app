...
class NegrosOccidentalPage extends StatefulWidget {
  @override
  _NegrosOccidentalPageState createState() => _NegrosOccidentalPageState();
}

class _NegrosOccidentalPageState extends State<NegrosOccidentalPage> {
